...
import qbosst.bossbot.bot.commands.ICommandManager
...
import qbosst.bossbot.entities.MessageCache
import qbosst.bossbot.util.*
...
object Listener : EventListener, ICommandManager
{
    ...
    private val listeners = loadClasses("qbosst.bossbot.bot.commands", EventListener::class.java)
    ...
    init
    {
        addCommands(loadClasses("qbosst.bossbot.bot.commands", Command::class.java).filter { it.parent == null })
    }
